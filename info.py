...
API_ID = int(environ.get('API_ID', '28300966'))
API_HASH = environ.get('API_HASH', 'c0a1fe56b13f260c62bc4838feb416d9')
BOT_TOKEN = environ.get('BOT_TOKEN', "8034895475:AAEBIFJ0RED4QOg2e7fEVwBFfzpMa2zFqyI")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7312906293').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002664707092'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002527105069').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002645681256') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002594971850')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002515561510').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mohamedrisham004:6rhkT3SNBiVe5yV8@cluster0.62t3vp9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Moviefatherv3')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviefatherv4')
SUPPORT_CHAT = environ.get('https://t.me/moviefatherv5', 'vj_bot_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/linkfatherv6')
